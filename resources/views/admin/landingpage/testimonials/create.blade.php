                        ...
                        <form action="{{ route('admin.testimonials.store') }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="investor_name" name="investor_name" value="{{ old('investor_name') }}"
                                            required>
                                        @error('investor_name')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="investor_title" name="investor_title" value="{{ old('investor_title') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="avatar_initials" name="avatar_initials" value="{{ old('avatar_initials') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('quote_text') is-invalid @enderror" id="quote_text" name="quote_text"
                                    rows="5" placeholder="বিনিয়োগকারীর মন্তব্য লিখুন..." required>{{ old('quote_text') }}</textarea>
