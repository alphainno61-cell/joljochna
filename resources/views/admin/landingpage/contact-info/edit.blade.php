                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="phone_title"
                                                    name="phone_title"
                                                    value="{{ old('phone_title', $phone['title'] ?? 'ফোন') }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="phone_content" class="form-label">ফোন নম্বর</label>
                                                <textarea class="form-control" id="phone_content" name="phone_content" rows="4"
                                                    placeholder="প্রতিটি ফোন নম্বর আলাদা লাইনে লিখুন" required>{{ old('phone_content', $phone['content'] ?? '') }}</textarea>
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="phone_active"
                                                    name="phone_active" value="1"
                                                    {{ $phone['is_active'] ?? true ? 'checked' : '' }}>
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="email_content" name="email_content" rows="4" placeholder="ইমেইল ঠিকানা"
                                                    required>{{ old('email_content', $email['content'] ?? '') }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="email_active"
                                                    name="email_active" value="1"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="website_title"
                                                    name="website_title"
                                                    value="{{ old('website_title', $website['title'] ?? 'ওয়েবসাইট') }}"
                                                    required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="website_content" class="form-label">ওয়েবসাইট URL</label>
                                                <textarea class="form-control" id="website_content" name="website_content" rows="4"
                                                    placeholder="ওয়েবসাইট ঠিকানা" required>{{ old('website_content', $website['content'] ?? '') }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label for="website_icon" class="form-label">আইকন</label>
                                                <select class="form-control" id="website_icon" name="website_icon"
                                                    required>
                                                    @foreach ($icons as $emoji => $label)
                                                        <option value="{{ $emoji }}"
                                                            {{ ($website['icon'] ?? '🌐') == $emoji ? 'selected' : '' }}>
                                                            {{ $label }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="website_active"
                                                    name="website_active" value="1"
                                                    {{ $website['is_active'] ?? true ? 'checked' : '' }}>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="address_title"
                                                    name="address_title"
                                                    value="{{ old('address_title', $address['title'] ?? 'ঠিকানা') }}"
                                                    required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="address_content" class="form-label">ঠিকানা</label>
                                                <textarea class="form-control" id="address_content" name="address_content" rows="4"
                                                    placeholder="সম্পূর্ণ ঠিকানা" required>{{ old('address_content', $address['content'] ?? '') }}</textarea>
                                                <small class="text-muted">প্রতিটি লাইন আলাদা লাইনে লিখুন</small>
                                            </div>
                                            <div class="mb-3">
                                                <label for="address_icon" class="form-label">আইকন</label>
                                                <select class="form-control" id="address_icon" name="address_icon"
                                                    required>
                                                    @foreach ($icons as $emoji => $label)
                                                        <option value="{{ $emoji }}"
                                                            {{ ($address['icon'] ?? '📍') == $emoji ? 'selected' : '' }}>
                                                            {{ $label }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="address_active"
                                                    name="address_active" value="1"
                                                    {{ $address['is_active'] ?? true ? 'checked' : '' }}>
