                        ...
                        <form action="{{ route('admin.projects.update', $project->id) }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('icon') is-invalid @enderror" id="icon"
                                            ...
                                            @foreach ($icons as $emoji => $label)
                                                <option value="{{ $emoji }}"
                                                    {{ old('icon', $project->icon) == $emoji ? 'selected' : '' }}>
                                                    {{ $label }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                    rows="3" placeholder="শহরের ঠিক মাঝে আপনার শান্তির ঠিকানা..." required>{{ old('description', $project->description) }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="button_text" value="{{ old('button_text', $project->button_text) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="button_link" value="{{ old('button_link', $project->button_link) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    ...
                                    @elseif($project->icon)
                                        <div style="font-size: 4rem; text-align: center;">{{ $project->icon }}</div>
                                        <small class="text-muted">বর্তমান আইকন</small>
                                    @else
                                        <span class="text-muted">কোন ইমেজ বা আইকন নেই</span>
                                    @endif
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            name="sort_order" value="{{ old('sort_order', $project->sort_order) }}">
                                        @error('sort_order')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
